        ...
        this.parent.trigger(events.dataBinding, e, function (args) {
            ...
            for (var _b = 0, _c = resultData; _b < _c.length; _b++) {
                ...
                if (typeof datas[_this.parent.eventFields.startTime] === 'string') {
                    datas[_this.parent.eventFields.startTime] = util.getDateFromString(datas[_this.parent.eventFields.startTime]);
                }
                if (typeof datas[_this.parent.eventFields.endTime] === 'string') {
                    datas[_this.parent.eventFields.endTime] = util.getDateFromString(datas[_this.parent.eventFields.endTime]);
                }
